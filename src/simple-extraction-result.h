...
#ifndef UKUIFILEMETADATA_SimpleExtractionResult_H
#define UKUIFILEMETADATA_SimpleExtractionResult_H
 ...
 */
class UKUIFILEMETADATA_EXPORT SimpleExtractionResult : public ExtractionResult
{
public:
...
#endif // UKUIFILEMETADATA_SimpleExtractionResult_H
